...
namespace PagelifeCycleSolNmsp
{
    public partial class PagelifeCycleClass : System.Web.UI.Page
    {
        ...
        protected void lblName_Disposed(object sender, EventArgs e)
        {
            Response.Write("lblName_Disposed");
        }

        protected void lblName_Init(object sender, EventArgs e)
        {
            Response.Write("lblName_Init");
        }

        protected void lblName_Load(object sender, EventArgs e)
        {
            Response.Write("lblName_Load");
        }

        protected void lblName_PreRender(object sender, EventArgs e)
        {
            Response.Write("lblName_PreRender");
        }

        protected void lblName_Unload(object sender, EventArgs e)
        {
            //Response.Write("lblName_Unload");
        }  
    }
}